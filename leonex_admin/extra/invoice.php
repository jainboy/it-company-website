                                ...
                                <div class="invoice p-3 mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <img src=".\slider_images\img\visa.png" alt="Visa">
                                            <img src=".\slider_images\img\mastercard.png" alt="Mastercard">
                                            <img src=".\slider_images\img\american-express.png" alt="American Express">
                                            <img src=".\slider_images\img\paypal2.png" alt="Paypal">
                                    ...
                                    <div class="row no-print">
                                        <div class="col-12">
                                            <button type="button" class="btn btn-success float-right"> <i class="fa fa-print"></i> Print Invoice
                                            </button>
