<body>
        ...
        <a href="index.html" class="logo mr-auto"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>
          ...
          <nav class="nav-menu d-none d-lg-block">
            <ul>
              ...
              <li class="drop-down"><a href="about_us">About</a>
                <ul>
              ...
              <li><a href="company_portfolio">Portfolio</a></li>
              <li><a href="product_pricing">Pricing</a></li>
      ...
      <div id="mySidenav" class="sidenav">
        <a href="#" id="enquire" data-toggle="modal" data-target="#myModal"></i>ENQUIRE</a>
        <a href="#" id="sidecontact"  onclick="openForm()">CHAT WITH US</a>
      </div>
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-footer">
          <button type="button" class="btn btn-info" data-dismiss="modal"><i class="icofont-close"></i></button>
        </div>
                        ...
                        <div class="card border-primary rounded-0">
                            <div class="card-header p-0">
                                <div class="bg-info text-white text-center py-2">
                                    <h3><i class="icofont-envelope"></i> Put Your Inquire</h3>
                                    <p class="m-0">If you have any doubt then erase a query our team will contact you as soon as possible</p>
                                </div>
                            </div>
                            <div class="card-body p-3">
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text"><i class="icofont-user text-info"></i></div>
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text"><i class="icofont-envelope text-info"></i></div>
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                        ...
                                        <select class="form-control" name="type">
                                          ...
                                          <option value="S.E.O. & S.M.O.">S.E.O. & S.M.O.</option>
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text"><i class="icofont-comment text-info"></i></div>
                                        </div>
                                        <textarea class="form-control" placeholder="enter your query" name="message" required></textarea>
                                    </div>
                                </div>

                                <div class="text-center">
                                    <input type="submit" name="submit" class="btn btn-info btn-block rounded-0 py-2">
                                </div>
                            </div>
...
<div class="chat-popup" id="myForm">
  <div class="chat_card">
						<div class="card-header msg_head">
							...
							<span id="action_menu_btn" onclick="closeForm()"><i class="icofont-close"></i></span>
						</div>
						...
						<div class="card-footer">
							<div class="input-group">
								<div class="input-group-append">
									<span class="input-group-text attach_btn"><i class="icofont-user"></i></span>
								</div>
								<textarea name="" class="form-control type_msg" placeholder="Type your message..."></textarea>
								<div class="input-group-append">
									<span class="input-group-text send_btn"><i class="icofont-paper-plane"></i></span>
								</div>
							</div>
						</div>
					</div>
...
if(isset($_POST['submit'])){
  ...
  $sql=mysqli_query($con,"INSERT INTO `enquiry`(`name`, `email`, `type`, `question`, `added_on`)  VALUES ('$name','$email','$type','$message','$added_on')");
  if($sql==TRUE){?>
    <script> alert('enquire ragistered successfully'); </script>
  <?php }
} 
?>